...
//        WebElement addressesInAccuont = driver.findElement(By.id("content"));
//        Select stateDropDownList = new Select(stateDropdownList);
//        stateDropDownList.selectByVisibleText(state);
//        class "address"
//        public boolean iC=
//        addressesInAccount = new address();
//        Assertions.assertFalse(iCanSeeThereIsAnAddresses()., "There should be an address");
    }
...
//        loginPage.loginAs("bbcivvedjmkjvdjapf@tcwlx.com", "KlauN2828!");
    }
    ...
    public void iEnterNewAliasAliasAddressAddressCityCityStateStateZipCodePostalCodeCountryCountryPhonePhone(String alias, String address, String city, String state, String postalCode, String country, String phone) {
...
//        WebElement stateDropdownList = driver.findElement(By.id("field-id_state"));
//        Select stateDropDownList = new Select(stateDropdownList);
//        stateDropDownList.selectByVisibleText(state);
    ...
    public void iVerifyCreatedAddressAliasAddressCityStateZipPostalCodeCountryPhone(String alias, String address, String city, String state, String postalCode, String country, String phone) {

        WebElement addresses = driver.findElement(By.xpath("/html/body/main/section/div/div/section/section/div[2]/article/div[1]"));
...
//        Assertions.assertTrue(vAddress.contains(state));
